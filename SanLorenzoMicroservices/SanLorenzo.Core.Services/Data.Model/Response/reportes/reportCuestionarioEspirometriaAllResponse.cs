...
{
    public class reportCuestionarioEspirometriaAllResponse
    {
        ...
        public string Pregunta1ASiNo_N { get; set; }
        public string Pregunta2ASiNo_N { get; set; }
        public string Pregunta3ASiNo_N { get; set; }
        public string Pregunta4ASiNo_N { get; set; }
        public string Pregunta5ASiNo_N { get; set; }
        public string Pregunta6ASiNo_N { get; set; }
        public string Pregunta7ASiNo_N { get; set; }
        public string Pregunta8ASiNo_N { get; set; }
        public string Pregunta9ASiNo_N { get; set; }

        public string Pregunta1BSiNo_N { get; set; }
        public string Pregunta2BSiNo_N { get; set; }
        public string Pregunta3BSiNo_N { get; set; }
        public string Pregunta4BSiNo_N { get; set; }
        public string Pregunta5BSiNo_N { get; set; }
        public string Pregunta6BSiNo_N { get; set; }
        public string Pregunta7BSiNo_N { get; set; }
        public string Pregunta8BSiNo_N { get; set; }
        public string Pregunta9BSiNo_N { get; set; }
        public string Pregunta10BSiNo_N { get; set; }
        public string Pregunta11BSiNo_N { get; set; }
        public string Pregunta12BSiNo_N { get; set; }
        public string Pregunta13BSiNo_N { get; set; }
