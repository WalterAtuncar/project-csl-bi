...
const EspecialidadesModal: React.FC<EspecialidadesModalProps> = ({
  isOpen,
  onClose
}) => {
  // Estados principales
  ...
  // Cargar especialidades al abrir el modal y resetear estados
  useEffect(() => {
    if (isOpen) {
      // Resetear todos los filtros y estados cuando se abre el modal
      setSearchTerm('');
  ...
  }, [especialidades, searchTerm, includeDeleted, pagination.currentPage, pagination.pageSize]);
              ...
              <div className="mb-6 bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                ...
                <div className="flex justify-between items-center">
                  <div className="text-sm text-gray-600 dark:text-gray-400">
                    {filteredEspecialidades.length} de {especialidades.length} especialidades
                  </div>
