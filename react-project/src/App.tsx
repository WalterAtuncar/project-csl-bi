...
import { ContaLayout, Dashboard, Egresos, CostosPersonal, CajaDiaria, FlujoConsolidado, Rentabilidad, Honorarios, Epidemiologia, Catalogos, Usuarios, Consultas, Especialistas } from './pages/Contabilidad';
      ...
      <Routes>
        ...
        <Route path="/conta" element={<ContaAuthProvider><ContaOutlet /></ContaAuthProvider>}>
          <Route element={<ContaLayout />}>
            ...
            {/* Consulta a BD en lenguaje natural (NL2SQL). Accesible a SA/CONTABILIDAD/GERENTE; el guardar/
                borrar se gatea por canWrite dentro de la pagina. El API valida rol + feature-flag (404 si OFF). */}
            ...
            {/* Atenciones y referencias por especialista (100% lectura; el API valida el trio LECTURA). */}
